...
def apply_sprite(frame, p2sprite, w, x, y, h):
	sprite = cv2.imread(p2sprite, -1)
	# sprite = cv2.resize(sprite, (w,h))
	sprite = cv2.resize(sprite, (w+50,h+30))#--->giving error if second person come
...
while True:
	...
	for face in faces:
		...
		# x1=face.right()
		# y2=face.bottom()
		# cv2.rectangle(frame,(x,y),(x1,y2),(0,255,0),3)
		# print(x)
		...
		apply_sprite(frame, r'D:/programming with python/level3 5 to 8/myLevel3Proj/Snapchat Filter/mustache.png', w2, x2-20, y2+10,h2)
		apply_sprite(frame, r'D:/programming with python/level3 5 to 8/myLevel3Proj/Snapchat Filter/hat.png', w0, x0, y0-100,h0)
